...
# JSON 파일 로드
with open('./행사.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
# CSV 파일로 저장
df.to_csv('./train_행사.csv', index=False, encoding='utf-8-sig')



# JSON 파일 로드
with open('./행사1.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
# CSV 파일로 저장
df.to_csv('./valid_행사.csv', index=False, encoding='utf-8-sig')